...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2023 14:37:31 GMT -->
<head>
   <!-- All Meta -->
	<meta charset="utf-8">
	...
	<!-- Page Title Here -->
	<title>Mandela : School and Education Management Admin Dashboard Template</title>
	...
	<div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
		<div class="login-aside text-center  d-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				...
				<p class="mb-4">User Experience & Interface Design <br>Strategy Group 6 Solutions</p>
			</div>
								...
								<form action="{{route('login.post')}}" method="POST">
									...
									<div class="row mb-4">
										<div class="col-xl-6 col-6">
											<a href="#" class="btn btn-outline-light d-block social-bx">
									...
									<div class="mb-3">
									  ...
									  <input type="email" name="email" class="form-control" id="exampleFormControlInput1" value="hello@example.com">
									</div>
									<div class="mb-3">
										<label for="exampleFormControlInput1" class="form-label mb-2 fs-13 label-color font-w500">Password</label>
									  <input type="password" name="password" class="form-control" id="exampleFormControlInput2" value="Password">
									</div>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2023 14:37:32 GMT -->
</html>