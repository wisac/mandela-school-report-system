...
<!-- Mirrored from akademi.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2023 14:36:37 GMT -->
<head>
    <meta charset="utf-8">
	...
	<!-- Page Title Here -->
	<title>Mandela : School and Education Management Admin Dashboard </title>
    ...
    <div id="main-wrapper" class="wallet-open active">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html"  >
				<div class="brand-title" > <h1 style="color: aliceblue"> Mandela </h1> </div>
									...
									<div class="dropdown-menu dropdown-menu-end pb-0" style="">
										<div class="card mb-0">
											...
											<div class="card-footer text-center p-3">
												<a href="{{route('logout')}}" class="dropdown-item ai-icon btn btn-primary light">
			...
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<span class="nav-">Parent</span>
					</a>
						<ul aria-expanded="false">
							<li><a href="food.html">Parent</a></li>
							<li><a href="food-details.html">Parent Detail</a></li>
						</ul>
					...
					<ul aria-expanded="false">
						<li><a href="file-manager.html">All Classes</a></li>
						<li><a href="user.html">Add new Class</a></li>	
					</ul>
					</li>
					<li><a class=" " href="file-manager.html" aria-expanded="false">
                    ...
                    <li><a class=" " href="file-manager.html" aria-expanded="false">
						<i class="material-icons">book</i>
						<span class="nav-text">Class Routine</span>
						</a>
					</li>
                    <li><a class=" " href="file-manager.html" aria-expanded="false">
						<i class="material-icons">book</i>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="chart-flot.html">Exam Schedule</a></li>
							<li><a href="chart-morris.html">Exam Grade</a></li>
						</ul>
					</li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="{{route('user.list')}}">Details</a></li>
						</ul>
					</li>
				<div class="copyright">
					<p><strong>School Admission Dashboard</strong></p>
					<p class="fs-12">Made by <span class="heart"></span>Groub 6</p>
				</div>
			</div>
        </div>
        <!--**********************************
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2023 14:37:13 GMT -->
</html>